...
` Apple fruit = new Fruit()`
 ...
 function submit(e) {
    if (document.getElementById("exercise-checkbox-1-false").checked && document.getElementById("exercise-checkbox-2-false").checked )
    {
  ...
  return (
    <>
                <div className="widgets">
                        ...
                        <p>Java compiler use declared type as the criteria to judge the methods and attributes that declared object should have.</p>
                        ...
                        <p>It is usually used in the array:</p>
                        <div className = "example">
                          <h3>Example</h3>
                           <pre className = "code" >
                              <Code>{obj4}</Code>
