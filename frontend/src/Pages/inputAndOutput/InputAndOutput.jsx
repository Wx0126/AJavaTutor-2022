...
function deliverNum(e) {
  ...
  if (e.keycode = 13) {
      if ((Number.isInteger(userinput.value)) || (userinput.value = "")) {
    ...
    return (
            ...
            <div className="widgets">
                ...
                <p>System is a built-in class in Java, we can directly use it, out means output, it also a class belonging to System. 
                   ...
                   Before using it, we need to import the package java.util.Scanner. 
                </p>
                <p>There are several methods of implementing reading different types of content. The example below uses different input methods to receive different inputted data.</p>
                <div className = "example">
                <h3>Example</h3>
                <pre className = "code" >
                <Code>{obj3}</Code>
