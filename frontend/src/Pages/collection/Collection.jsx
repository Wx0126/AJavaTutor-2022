  ...
  function submit4 (e) {
    ...
    return (
            ...
            <div className="widgets">
                ...
                <p>
                The list class do not have a fixed capacity, we don't need to formulate its length when we initialize it, this is different from array. The length of the list fluctuates when new components are added or removed.
               It includes three subclasses:
               ...
               <p>Notice the word in the angle brackets is the class the elements in the list belong to, because the element in the list must 
                be an object, so we must use the class name rather than type name for primitive types, e.g. using Integer rather than Int.</p> 
               ...
               <br/>The accompanying method of list is also different from array, list has following methods:
            ...
            <div className="widgets">
                ...
                <p>
                The items in a set must be identical with each other, if the user inserts an item that is the same with one existing item in the set, the new item won't be added, set will reserve only the former one.
                Subclasses of set include HashSet, LinkedHashSet, TreeSet. These subclasses implement the interface Set. It doesn't have a fixed length either. we can also only use add() method to add element to it one by one.
                ...
                <table>
                 ...
                 <p>The following example will output a 1:</p>
                 <div className = "example">
                 <h3>Example</h3>
                 <pre className = "code" >
                 <Code>{obj3}</Code>
            ...
            <p>
            Queue is a first-in-first-out collection. We can't access elements by the index, we can only get the head of the sequence every time and insert an element into the tail of the sequence.
            ...
            <div className="widgets">
                ...
                <button onClick = {(e) => {submit4(e)}} id = "question14041" className="testbutton" >Submit</button>               
               </div>       
            </div>
        </>   
