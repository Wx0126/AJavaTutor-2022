  ...
  return (
    <>
                <div className="widgets">
                       ...
                       <p>
                       In the run time, if the actual object doesn't have the called method, java will goes to its superclass to find, if this class doesn't have either, java keeps to go to its superclass until it finds.
                       </p>        
                ...
                <p>
                This knowledge is also useful when we want to use a method only exiting in some of the subclasses of one superclass:
                </p>
                <div className = "example">
                          <h3>Example</h3>
                           <pre className = "code" >
